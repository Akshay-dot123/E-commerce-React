  ...
  return (
    ...
    >
      ...
      >
        ...
        {loading && <p style={{ marginTop: "10px", color: "#007bff" }}>Creating user...</p>}
        {error && <p style={{ marginTop: "10px", color: "red" }}>Error: {error.message}</p>}
        {data && <p style={{ marginTop: "10px", color: "green" }}>User created: {data.createUser.email}</p>}
      </div>
    </div>
  );
